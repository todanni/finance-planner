...
const Schema: z.ZodType<Prisma.SubCategoryUncheckedUpdateManyWithoutCategoryNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const SubCategoryUncheckedUpdateManyWithoutCategoryNestedInputObjectSchema =
  Schema;
