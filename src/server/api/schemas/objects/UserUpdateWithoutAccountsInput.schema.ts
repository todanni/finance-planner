...
import { BalanceUpdateManyWithoutUserNestedInputObjectSchema } from "./BalanceUpdateManyWithoutUserNestedInput.schema";
...
const Schema: z.ZodType<Prisma.UserUpdateWithoutAccountsInput> = z
  .object({
    ...
    image: z
      ...
      .nullable(),
    balances: z
      .lazy(() => BalanceUpdateManyWithoutUserNestedInputObjectSchema)
      .optional(),
    payments: z
