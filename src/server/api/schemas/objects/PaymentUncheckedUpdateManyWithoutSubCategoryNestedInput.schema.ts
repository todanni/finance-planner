...
const Schema: z.ZodType<Prisma.PaymentUncheckedUpdateManyWithoutSubCategoryNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PaymentUncheckedUpdateManyWithoutSubCategoryNestedInputObjectSchema =
  Schema;
