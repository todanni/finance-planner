...
const Schema: z.ZodType<Prisma.PaymentUncheckedCreateNestedManyWithoutSubCategoryInput> =
  z
    .object({
      create: z
        .union([
...
export const PaymentUncheckedCreateNestedManyWithoutSubCategoryInputObjectSchema =
  Schema;
