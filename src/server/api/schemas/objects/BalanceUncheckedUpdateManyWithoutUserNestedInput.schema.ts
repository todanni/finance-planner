...
const Schema: z.ZodType<Prisma.BalanceUncheckedUpdateManyWithoutUserNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => BalanceUpsertWithWhereUniqueWithoutUserInputObjectSchema
          ),
          z
            .lazy(
              () => BalanceUpsertWithWhereUniqueWithoutUserInputObjectSchema
      ...
      update: z
        .union([
          z.lazy(
            () => BalanceUpdateWithWhereUniqueWithoutUserInputObjectSchema
          ),
          z
            .lazy(
              () => BalanceUpdateWithWhereUniqueWithoutUserInputObjectSchema
...
export const BalanceUncheckedUpdateManyWithoutUserNestedInputObjectSchema =
  Schema;
