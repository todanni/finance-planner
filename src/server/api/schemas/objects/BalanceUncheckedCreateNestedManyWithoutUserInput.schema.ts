...
const Schema: z.ZodType<Prisma.BalanceUncheckedCreateNestedManyWithoutUserInput> =
  z
    .object({
      create: z
        .union([
...
export const BalanceUncheckedCreateNestedManyWithoutUserInputObjectSchema =
  Schema;
