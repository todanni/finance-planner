  ...
  return (
    <div>
      ...
      <label className="inline-flex w-full cursor-pointer items-center rounded-lg p-2.5 text-sm text-white">
        ...
        <span className="rounded-l-lg bg-grn-700 px-4 py-2 peer-checked:bg-gray-400">
          {defaultOption}
        </span>
        <span className="rounded-r-lg bg-gray-400 px-4 py-2 text-sm peer-checked:bg-grn-700">
          {secondaryOption}
        </span>
      </label>
    </div>
